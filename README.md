...
- 4つの入口と中央の部屋の位置は固定ですが、迷路の構造は試合ごとに変化します。
- 中央の部屋には金の宝箱が必ず1つ配置され、迷宮内には一般の宝箱も配置されます。
- 宝箱は4チームのどの入口へ持ち帰っても、運んだチームの得点になります。
- 宝箱を運搬中のキャラクターは移動速度が遅くなり、攻撃できません。
- ほかのパーティーのキャラクターとは戦闘が発生しますが、モンスターは出現しません。
...
探索先や役割分担、金の宝箱と一般の宝箱のどちらを狙うか、宝箱をどの入口へ運ぶか、運搬中の仲間をどう守るかなどを判断します。
